...
if __name__ == "__main__":
    ...
    stat_repository = StatRepository(db.conn)
    # create services
    ...
    for link in match_links:
        game_dto = scraper.get_match_related_data(link)
        player_stat_dtos, player_profile_dtos = scraper.get_player_stats_for_match(
            match_endpoint=link,
